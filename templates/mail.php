<?php
/**
 * @var string $mail_text текст письма
 */
                ...
                <table border="0" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td align="center" valign="top">
                            <!-- BEGIN BODY // -->
                            <table border="0" cellpadding="0" cellspacing="0"
                                   width="100%" id="templateBody">
                                <tr>
                                    <td valign="top" class="bodyContent"
                                        mc:edit="body_content">
                                        <h1>Сервис "ДЕЛА В ПОРЯДКЕ"</h1>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0"
                                ...
                                <tr>
                                    <td valign="top" class="footerContent"
                                        ...
                                        <em>Copyright &copy; Roman Kuzmin.</em>
                                        <br/>
                                        <br/>
                                        <strong>Наша электронная почта:</strong>
                                        <br/>
                                        keks@phpdemo.ru
                                    </td>
                                </tr>
